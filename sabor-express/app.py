...
restaurantes = [{'nome': 'Sabor de Minas', 'categoria': 'Comida Brasileira',
                 'ativo': False},
                {'nome': 'Sushi do Japa', 'categoria': 'Comida Japonesa',
                 'ativo': True},
                {'nome': 'Hamburgueria do Beco', 'categoria': 'Fast Food',
                 'ativo': True},
                ]
...
def listar_restaurantes():
    ...
    print(f'{'  Nome do restaurante'.ljust(30)}│{' Categoria'.ljust(29)}│
          {' Status'}')
    for restaurante in restaurantes:
        nome_do_restaurante = restaurante['nome']
        categoria = restaurante['categoria']
        ativo = 'Ativado' if restaurante['ativo'] else 'Desativado'
        print(f'- {nome_do_restaurante.ljust(27)} │ {categoria.ljust(27)}│
              {ativo}')
...
def alternar_estado_restaurante():
    ...
    for restaurante in restaurantes:
        if nome_restaurante == restaurante['nome']:
            ...
            com sucesso' if restaurante['ativo'] else f'O restaurante 
